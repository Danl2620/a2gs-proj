...
(gs-struct gs-string (len u8) (char (array[] s8)))
...
(define shr-screen-320
    (rb #:start #xe12000 #:size (tuple 320 200) #:bpp 4))

(define shr-screen-640
    (rb #:start #xe12000 #:size (tuple 640 200) #:bpp 2))

(define vec2 (x s16) (y s16))
